...
{
if((objectiveFunction[i]=='x' || objectiveFunction[i]=='X') && (objectiveFunction[i+1]>='0' && objectiveFunction[i+1]<='9'))
...
for(int i=0; i<objectiveFunction.length(); i++)
{
if((objectiveFunction[i]>='0' && objectiveFunction[i]<='9') || objectiveFunction[i] == '-' || objectiveFunction[i] == '+')
tmp = tmp + objectiveFunction[i];
...
void makeStandardizeFormOfConstrain(string constrain, double coefficient[], int length,int numberOfConstrain, int constrainNumber)
{
...
updateCoefficientOfObjectiveFunction(objectiveFunction, coefficientOfObjectiveFunction, lengthOfcoefficientOfObjectiveFunction);

for(int i=0; i<numberOfConstrain; i++)
updateCoefficientOfConstrains(constrain[i], coefficientOfConstrains[i], lengthOfcoefficientOfObjectiveFunction+1);
...
for(int i=0; i<numberOfConstrain; i++)
makeStandardizeFormOfConstrain(constrain[i], coefficientOfConstrains[i], lengthOfcoefficientOfObjectiveFunction+1, numberOfConstrain, i);
